...
const Header = () => {
  ...
  return (
    <div className="absolute px-8 py-2 bg-gradient from-black z-10 flex justify-between w-full">
      <img
        className="w-44"
      ...
      {user && <div className="flex">
        <img
          className="w-12 h-12"
          src="https://occ-0-4994-3662.1.nflxso.net/dnm/api/v6/SO2HoVCx33X8phZh2pZZmQ4QgNY/AAAABS8sWFjSyj1zyfgcnGamqyJ1E2ZubZGo8dndCM_ipf_5UpmVlkuf8IXzQlmPZQqTMWNjWukESRdLkFGHnf7zbY3MJCO3r4s.png?r=229"
          alt="usericon"
          // src={user.photoURL} 
        />
